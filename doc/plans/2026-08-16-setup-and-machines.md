...
| **Status** | **M8 complete (2026-08-20, verified in a browser)** · M9 done except image upload and the HTTP half of its verification · **M10 next** · M11 still blocked on an owner action — bands 10–13 in [`MasterTaskQueue.md`](../tasks/MasterTaskQueue.md) |
