...
| **Status** | 🟡 decomposed 2026-08-23, not built |
| **Open questions** | none |
...
|---|---|---|---|---|
| [T-M14-01 — three waiting-reason cards, and TTL-expiry told apart from a real failure](T-M14-01-waiting-reason-cards.md) | `[S]` | US2 | — | not started |
| [T-M14-02 — the Knowledge Center names the specific waiting states and the 24h wait](T-M14-02-knowledge-center.md) | `[P]` | US2 | — | not started |
| [T-M14-03 — verification](T-M14-03-verification.md) | `[S]` | US2 | 14.1, 14.2 | not started |
...
today, the signal T-M14-01 needs — inferred from reading the SQL, not yet
seen against a real expired row, which is why T-M14-01's checklist requires
confirming it live before shipping it as load-bearing.
