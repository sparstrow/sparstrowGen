...
| [`BUG-2026-08-24-claude-browser-pane-reports-hidden-visibility`](BUG-2026-08-24-claude-browser-pane-reports-hidden-visibility.md) | 🔴 open | The in-app Claude Browser preview pane (`mcp__Claude_Browser__*`) reports `document.visibilityState === "hidden"` on a fresh, foregrounded navigation, starving any page whose data fetching gates on visibility (React Query throughout this app). Confirmed live 2026-08-24 while evaluating it as a Playwright replacement. Already why the runbook prescribes Playwright instead; this gives that known issue its own tracked bug |
