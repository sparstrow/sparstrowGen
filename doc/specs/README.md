...
| [`2026-08-31-browser-loopback-pairing`](2026-08-31-browser-loopback-pairing.md) | ✅ reviewed 2026-08-31 — accepted live | [`plan`](../plans/2026-08-31-browser-loopback-pairing.md) | Replaces the typed pairing code with a browser-loopback flow — `sparstrow pair` opens an already-signed-in browser tab and pairing completes with nothing to read or type, modeled on [multica](../../references/multica)'s `multica login`. Headless/remote pairing (no local browser) is knowingly dropped, filed as [`D-29`](../Deferred.md) |
