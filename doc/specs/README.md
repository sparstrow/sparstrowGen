...
|---|---|---|---|
| [`2026-08-16-setup-and-machines`](2026-08-16-setup-and-machines.md) | ✅ reviewed 2026-08-16 — planned, M8–M11 | [`plan`](../plans/2026-08-16-setup-and-machines.md) | From a fresh account to a working machine: an interactive setup guide, a dedicated Machines menu with CRUD, and active/unreachable status, pairing against `staging.sparstrow.com`. Its US3–US5 scenarios *are* the verification pass `G-12`/`G-16` have been waiting for. **US1 scenario 3 and US4 (the pairing-code behavior) are superseded** by the spec below |
| [`2026-08-31-browser-loopback-pairing`](2026-08-31-browser-loopback-pairing.md) | ✅ reviewed 2026-08-31 — shipped, **superseded 2026-09-02** | [`plan`](../plans/2026-08-31-browser-loopback-pairing.md) | Replaces the typed pairing code with a browser-loopback flow — `sparstrow pair` opens an already-signed-in browser tab and pairing completes with nothing to read or type, modeled on [multica](../../references/multica)'s `multica login`. Headless/remote pairing (no local browser) is knowingly dropped, filed as [`D-29`](../Deferred.md) |
| [`2026-09-02-computers-that-are-just-there`](2026-09-02-computers-that-are-just-there.md) | **Draft — awaiting owner review** (four framing decisions taken live 2026-09-02; the written form not read back) | [`plan`](../plans/2026-09-02-computers-that-are-just-there.md) | Connecting a computer stops being a step. The desktop app connects the machine it runs on the moment you sign in, that machine stays reachable whenever the laptop is on (not only while a window is open), one machine serves every workspace you own with a switcher between them, and one page lists what has access. **Supersedes [`2026-08-31-browser-loopback-pairing`](2026-08-31-browser-loopback-pairing.md) entirely** — a machine now authenticates as the person, not as one workspace, an explicitly widened blast radius the owner chose after being shown the trade. Closes [`D-29`](../Deferred.md) (headless pairing); opens `D-30` (machines in other people's workspaces) |
