...
import type { MemoryScopeKind, MemorySearchHit } from "@sparstrow/shared";
...
export function MemoryPage() {
  ...
  const [searchHits, setSearchHits] = React.useState<MemorySearchHit[] | null>(null);

  const health = useHealth();
  const notes = useMemoryNotes(scopeTab === "all" ? {} : { scope: scopeTab });
      ...
      <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              The markdown file is deleted from the vault. This cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
