...
> **This is the primary design system**, rebuilt 2026-08-19 against the current
> `DESIGN.md` doctrine. It replaced the original `design-system/` on 2026-09-01
> after a comparison period found this version's tokens accurate to real code
> with no invented values — see `DECISIONS.md` for the design-decision history
> carried over from the original, and `designs/` for its prototype handoffs.
